...
def load_drug_gene_mapper():
    ...
    def get_pubchem_similars(smiles, threshold=98):
        try:
            url = f"https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/fastsimilarity_2d/cid/2244/cids/JSON?Threshold={threshold}&MaxRecords=5"
